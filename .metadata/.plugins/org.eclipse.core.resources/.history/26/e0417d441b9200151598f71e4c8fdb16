...
public class CruzCompleta extends KarelMejorada{
	...
	/**
	 * Este Método dibuja el Tercer Lado de la Cruz
	 */
	private void dibujaTercerLado() {
		...
		//a la posición del beeper inicial
		while(beepersPresent()) {
			move();
		}
		
		//8. Devuleve el beeper inicial, que Karel había tomado prestado
		putBeeper();
	}
	
	/**
	 * Éste Método dibuja el cuarto lado de la Cruz
	 */
