 ...
 * 
 * Definimos tres constantes al inicio de la clase, que nos permiten modificar fácimlente varios parámetros
 * N_FILAS almacenará el número de filas
 * N_COLUMNAS almacenará el número de columnas
 * TAMANIO_CASILLA almacenará el tamaño en pixels de caa casilla del tablero (nunca utilizar "ñ" o "tildes")
 * 
 ...
 * entender mejor qué está haciendo el programa.
 */
...
public class TablejorAjedrez extends acm.program.GraphicsProgram{
	...
	//que hay (numeros, palabras...); para los Nº Enteros se usa el int
	//private static (tipo) (nombre de la constante) = (valor de la constante)
	private static int N_FILAS = 8; //Las constantes siempre se ponen en MAYÚSCULAS
