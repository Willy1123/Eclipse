...
public class Game extends JPanel{
	//Defino el tamaño de la ventana donde va a estar el juego
	private Dimension gameField = new Dimension(400, 300); 
	private Player player;

	public Game(Frame container) {
		//Define que la barra del jugador se va a mover con el ratón
	...
	public void setSize(Dimension size) {
		...
		//Coloca la barra de jugador abajo, donde tiene que está
	...
	public void paint(Graphics g) {
		...
		//Te centra siempre el juego, independientemente del tamaño de la pantalla
		g.translate((getWidth() - gameField.width)/2, (getHeight() - gameField.height)/2);

		//Añade propiedades a la ventana del juego, como el color de la ventana,
		//el borde y el tamaño de la ventana
		g.setColor(Color.WHITE);
		g.fillRect(0, 0, gameField.width, gameField.height);
		g.setColor(Color.BLACK);
		g.drawRect(0, 0, gameField.width, gameField.height);

		//Añade la barra del jugador
		player.render(g);
	}
